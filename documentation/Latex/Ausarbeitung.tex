...
\section{Fehlersuche und Debugging}
...
Dadurch können Informationen über die Performance der Tests erhalten und im Fall von auftetenden Fehlern und 
...
Datei am Ende eines Jobdurchlaufes als Artifact zur Verfügung gestellt werden.

\subsection{Debugging mit SSH}
CircleCI bietet im Fall eines auftetenden Fehlers die Möglichkeit zum Debuggen mit SSH. Dadurch ist es 
...
"Permission denied" Fehler aufteten, besteht die Möglichkeit über einzelne Kommandos die angegebenen Nutzer 
